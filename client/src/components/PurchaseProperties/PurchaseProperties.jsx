...
import classes from './PurchaseProperties.module.css'
...
const PurchaseProperties = () => {
  ...
  useEffect(()=>{
    const fetchFeatured=async()=>{
      try {
        const data=await request('/property/find/purchase','GET');
        console.log(data)
      ...
      <div className={classes.container}>
        <div className={classes.wrapper}>
          <div className={classes.titles}>
            <h5>Properties you may like For Purchase</h5>
...
export default PurchaseProperties